'use client';
// [review:need-review] PHASE-01/73-dashboard-hero-today-ring, PHASE-03/123, #176
// summary: mobile Dashboard includes unit-aware Continue tracking cards
...
import { ContinueTracking } from '@/components/ContinueTracking';
...
export default function MobileDashboardPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-rise">
      ...
      <ContinueTracking categories={categories} entries={continueEntries} mobile />
