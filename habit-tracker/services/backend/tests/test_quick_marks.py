...
# Предшественник в этой ветке — ревизия #110. Дорожки заводят ревизии
# параллельно, и `down_revision` вписывается по фактическому `alembic heads`
# ветки, а не по тому, что было в ветке-источнике.
PREVIOUS_REVISION = "b2d4f6a8c0e3"
