...
class IsolatedCli:
    ...
    def build_argv(
        self, *, system_prompt: str, output_args: Sequence[str]
    ) -> list[str]:
    ...
    async def spawn(
        self, *, system_prompt: str, output_args: Sequence[str], stderr: int
        ...
        return await asyncio.create_subprocess_exec(
            *self.build_argv(system_prompt=system_prompt, output_args=output_args),
