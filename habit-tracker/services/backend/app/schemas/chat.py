...
#
# Поднят с 20 000 в `#193`, когда в реплику стало можно приложить текстовый файл:
# конспект дня и недельный csv не влезали в прежний потолок, а хранилища
# вложений в проекте нет — содержимое файла и есть часть сообщения. Сто тысяч
# знаков — это примерно двадцать пять тысяч токенов на ход: дорого, но
# договоримо, и человек платит за это осознанно, приложив файл руками.
