 ...
 * (a nested route of a flat screen, say) with `mode=mobile` stored therefore
 * spends the marker without moving anywhere, and the user stays on the desktop shell until the
