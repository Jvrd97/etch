...
describe('MOBILE_ROUTES', () => {
  ...
  it('covers every screen except the ones still waiting for their mobile slice', () => {
    // `/chat` спустился на телефон в #118, и исключений осталось два.
    ...
    // страницы. `inbox` (#97): входящие разбирают за столом, планируя день, и
    // первый срез контура даёт им один экран, а не два. Список, а не
    // «исключений нет»: следующий экран без близнеца придётся дописать сюда
    // осознанно.
