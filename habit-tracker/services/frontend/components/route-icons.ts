...
// summary: route id -> lucide icon map (+ the Day summary and Day glyphs) — keeps the UI dependency out of lib/routes so the registry stays importable from server modules
