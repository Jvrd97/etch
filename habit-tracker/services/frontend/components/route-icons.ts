...
// summary: route id -> lucide icon map (+ the Day summary, Day, Goals, Chat and Day rules glyphs) — keeps the UI dependency out of lib/routes so the registry stays importable from server modules
